...
export default defineComponent({
  ...
  setup() {
    ...
    watch(toRef(map, 'isLoaded'), () => console.log('IS LOADED', map), {
      immediate: true,
    });
    watch(toRef(map, 'isMounted'), (v) => console.log('IS MOUNTED', v), {
      immediate: true,
    });
    ...
    return {
      ...
      mapStyles: [
        ...
        },
        {
          ...
          label: 'Voyager',
          style:
            'https://api.maptiler.com/maps/voyager/style.json?key=' +
            import.meta.env.VITE_MAPTILER_KEY,
        },
      ] as StyleSwitchItem[],
  ...
  mounted() {
    ...
    setInterval(
      () => (this.geoJsonSource.show.value = !this.geoJsonSource.show.value),
      1000
    );
  },
});
